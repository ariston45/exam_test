<?php
	switch ($_GET['pg']) {
		case 'customer':
			include 'view_admin_support/1_customer.php';
			break;	
		...
		case 'customer_stock':
			...
			include 'view_admin_support/1_detail_voucher.php';
			break;	
		case 'customer_stock_detail':
			include 'view_admin_support/1_detail_history_V.php';
			break;
		case 'customer_program':
			include 'view_admin_support/1_man_voucher.php';
			break;
		case 'exam_status':
			//include '../assets/error-404/index.html';
			include 'view_admin_support/8_schedule_status.php';
			break;
		...
		case 'man_activity':
			...
			break;
		case 'schedule':
			include 'view_admin_support/8_schedule.php';
			break;
		case 'schedule_detail':
			include 'view_admin_support/8_schedule_detail.php';
			break;
		case 'users':
