...
if ($_SESSION["admin_level"]=="Administrator"){
	...
	$menu="admin_program_manager_sm.php";
	$container="admin_program_manager_container.php";
				...
				<ul class="nav navbar-top-links navbar-right">
					<li class="dropdown"><a data-toggle="dropdown" href="#" style="color: white;"><em class="fa fa-user-circle-o"></em><?php echo $_SESSION["admin_level"];?></a>
						<ul class="dropdown-menu">
							<li>
								<div class="all-button"><a href="#" data-id="<?=$_SESSION['admin_id']?>" data-toggle="modal" data-target="#edit_akun"><em class="fa fa-user"></em> Profile</a></div>
							</li>
							<li class="divider"></li>
							<li>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<div class="profile-sidebar">
			...
			<div class="profile-usertitle" style="float: none; margin:0px ">
				<div class="profile-usertitle-name" style="font-size: 18px; text-align: center;">
					<?=$name?>
				</div>
			</div>
			<div class="clear"></div>
