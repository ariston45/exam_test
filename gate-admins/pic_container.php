...
switch ($_GET['pg']) {
	...
	case 'pic_student_edit':
		include 'view_pic/2_pic_student_edit.php';
		break;
	case 'pic_exam':
		include 'view_pic/3_pic_exam.php';
		break;
	case 'detail_exam':
			include 'view_pic/6_detail_history_V.php';
			break;
	...
	case 'st_home_schedule':
		include 'view_pic/7_pic_exam_schedule.php';
		break;
	case 'st_home_create_exam':
		include 'view_pic/7_pic_create_exam.php';
		break;
	case 'st_home_exam_edit':
		include 'view_pic/7_pic_exam_edit.php';
		break;
	case 'st_home_sch_detail':
		include 'view_pic/7_pic_sch_detail.php';
		break;
	case 'st_home_exam_result':
		include 'view_pic/7_pic_exam_result.php';
		break;
	case 'st_home_create':
		include 'view_pic/7_pic_exam_create.php';
		break;
	case 'st_home_result_detail':
		include 'view_pic/7_pic_result_detail.php';
		break;
	case 'admin_showReport':
		include 'view_pic/5_1show_report.php';
		break;	
	default:
		// include 'view_pic/5_pic_classroom.php';
		include 'view_pic/pic_dashboard.php';
