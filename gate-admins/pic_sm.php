<ul class="nav menu">
	...
	<li <?php if(isset($_GET['pg']) 
		AND $_GET['pg'] == 'pic_voucher' OR $_GET['pg'] == 'pic_detail_voucher'OR $_GET['pg'] == 'detail_exam'){echo 'class="active"';}?>>
	...
	<li <?php if(isset($_GET['pg']) AND $_GET['pg'] == 'pic_report' OR $_GET['pg'] == 'pic_report_view' OR  $_GET['pg'] == 'admin_showReport'){echo 'class="active"';} ?> >
  ...
  if ($rs_config[1]==1) { ?>
		<li <?php if(isset($_GET['pg']) AND 
			$_GET['pg'] == 'st_home_create_exam' OR 
			$_GET['pg'] == 'st_home_create' OR 
			$_GET['pg'] == 'st_home_schedule' OR 
			$_GET['pg'] == 'st_home_sch_detail'OR 
			$_GET['pg'] == 'st_home_exam_result'OR 
			$_GET['pg'] == 'st_home_result_detail' )
			{echo 'class="active"';} ?> >
			<a data-toggle="collapse" href="#sub-item-3">
				<em class="fa fa-navicon">&nbsp;</em> Exams at home
				<span data-toggle="collapse" class="icon pull-right">
					<em class="fa fa-plus" style="padding-top: 6px;"></em>
				</span>
			</a>
			<ul class="children collapse" id="sub-item-3">
				<li <?php if (isset($_GET['pg']) AND $_GET['pg'] == 'st_home_schedule') {echo 'class="active"';} ?>>
				<a class="" href="?pg=st_home_create">
					<span class="fa fa-book">&nbsp;</span> Create Exam
				</a></li>
				<li><a class="" href="?pg=st_home_schedule">
					<span class="fa fa-calendar">&nbsp;</span> Exam Schedule
				</a></li>
				<li><a class="" href="?pg=st_home_exam_result">
					<span class="fa fa-list-ol">&nbsp;</span> Exam Result
				</a></li>
			</ul>
		</li> 
