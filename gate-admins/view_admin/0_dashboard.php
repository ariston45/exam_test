				...
				<tbody>
					...
					while($row = mysqli_fetch_array($result)){
						...
						if (mysqli_num_rows($rs)>0) {
							...
							$button_pic = '<a href="?pg=detail_customer&CC='.$row[0].'" class="btn btn-xs btn-info" style="padding-left: 10px;padding-right: 9px;"> <i class="fa fa-info-circle"></i> Detail</a>';
						} else {
