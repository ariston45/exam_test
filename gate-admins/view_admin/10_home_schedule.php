      ...
      <div class="panel-heading">Exam Schedule Master</div>
        <div class="panel-body">
             <table class="table table-xs" id="tbExam">
              ...
              <tbody><?php
              $no = 1;
              $result=CovidshowAllExam($_SESSION["admin_group"]);
              while($row = mysqli_fetch_array($result)){
                ...
                <tr>
                  ...
                  echo '</td>
                  <td>'.$row[6].'</td>
                  <td><a href="?pg=home_schedule_detail&CC='.$row[0].'" class="btn btn-xs btn-primary"><i class="fa fa-info-circle"></i>  Detail</a> ';
                  if ($row[5]!='init') {
                    echo '';
                  }
                  // if ($row[5]=='run') {
