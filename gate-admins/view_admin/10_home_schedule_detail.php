	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
						<a href='?pg=home_schedule' class='btn btn-xs btn-danger'><i class='fa fa-arrow-left'></i> Back</a>
						<br><br>
...
<script>
	$(document).ready(function(){
      ...
      $.ajax({
        type : 'GET',
        url  : 'view_proctor/3_proc_dataparticipant.php', //Here you will fetch records
        data : {id:idg},   //Pass $id
        success : function(data){
          $('#output').html(data);
        }
