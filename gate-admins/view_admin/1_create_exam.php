            ...
            $result=editExamVoucher($id_g);
              while ($row = mysqli_fetch_array($result)) {
                ...
                echo "
                  <div class=\"col-md-4\">
                    <div class=\"panel panel-info\" style=\"border: 1px solid #30a5ff;\">
                      ...
                      Voucher : <b>".$voucher."</b><br><br>
                        <table style='font-size:14px; width:100%; border:1px solid'>
                          <tr>
                            <td colspan=3><b>Subject Exam</b></td>
                          </tr>
                          ";
                ...
                echo "
                        ...
                        if($row[3]<=0){
                          if ($row[5]=='Postpaid') {
                          echo "<a href=\"?pg=create_exam_schedule&CC=".$row[0]."&id_g=$id_g\" class=\"btn btn-block btn-sm btn-danger\">Use</a>";
                          } else {
                          echo "<button type=\"button\" class=\"btn btn-block btn-sm btn-danger\" onclick=notif('".$row[0]."','$id_g')>Use</button>";
                          }
                        }else {
                          echo "<a href=\"?pg=create_exam_schedule&CC=".$row[0]."&id_g=$id_g\" class=\"btn btn-block btn-sm btn-danger\">Use</a>";
                        }
