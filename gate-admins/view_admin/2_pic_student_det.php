			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-md-6 text-right">
						<a href="?pg=pic_student_edit&cst=<?=$cst?>&ids=<?=$ids?>" class="btn btn-xs btn-primary">Edit</a> 
						<a href="?pg=detail_customer&CC=<?=$cst?>" class="btn btn-xs btn-danger">Close</a> 
					</div>
				</div>
			</div>
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-md-12">
						<?php
						$n = 0;
						$dataProgram = showVoucher($cst, ' group by a.id_program');
