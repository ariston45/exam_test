					...
					<?php
						...
						while($row = mysqli_fetch_array($result)){
							...
							<tr>
								...
								<td>'.$row[9].'</td>
								<td style="width:9%">
								<button type="button" class="btn btn-sm btn-primary  "  data-id="'.$row[0].'" data-toggle="modal" data-target="#edit_question"><i class="fa fa-edit"></i> </button>';
								if ($_SESSION["admin_level"] == "Administrator") {
									echo '<button type="button" class="btn btn-sm btn-danger " data-id="'.$row[0].'"  data-toggle="modal" data-target="#delete_question"><i class="fa fa-trash"></i> </button>';
								}
								echo'
							</td>
							</tr>';
