				...
				<div class="row">
					...
					<div class="col-lg-3" style="padding-left: 15px; padding-right: 5px;">
						...
						<ul class="nav nav-pills" style="    display: inline-grid; width: 100%;">
							<li class="active"><a href="#pilltab1" class="btn btn-block btn-primary  " data-toggle="tab">Customer Statistics</a></li>
							<li><a href="#pilltab2" class="btn btn-block btn-primary " data-toggle="tab">Voucher Statistics</a></li>
							<li><a href="#pilltab3" class="btn btn-block btn-primary " data-toggle="tab">Customer Exam</a></li>
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade  in" id="pilltab6">
								...
								?>
									...
									<input type="checkbox" name="fromhome" value="Y"> <label>Exam at Home</label>
