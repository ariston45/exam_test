...
function ExamGelombang($header, $id_voucher, $start, $end)
{
	...
	$doc->setActiveSheetIndex(0)
		...
		->setCellValue('F4', $examheader[2])
		->setCellValue('G4', $examheader[0])
		->setCellValue('H4', $examheader[1])
	...
	$doc->setActiveSheetIndex(0)
		...
		->setCellValue('F' . $baris, 	$examheader[2])
		->setCellValue('G' . $baris, 	$examheader[0])
		->setCellValue('H' . $baris, 	$examheader[1])
