			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-6">
						...
						<button class="btn btn-xs btn-primary" data-id="<?= $id_voucher; ?>" data-toggle="modal" data-target="#topup_voucher"><i class="fa fa-shopping-cart"></i> Transaction</button>
			...
			<form role="form" action="?pg=admin_adminTopUp" method="POST" autocomplete="off">
				<div class="modal-body">
					<div class="form-group">
						...
						<input class="form-control" name="id_voucher" value="<?= $id_voucher; ?>" readonly>
					</div>
					<div class="form-group">
