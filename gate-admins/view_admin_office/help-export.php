...
function ExamGelombang($header, $id_voucher, $start, $end)
{
	...
	$end    = $_POST['end'];
	$param    = $_POST['param'];
	$list = array(2 => 'sesi', 'nim', 'nama', 'nilai_w', 'nilai_e', 'nilai_p', 'nilai', 'status');
	...
	$doc->getActiveSheet()->getStyle('A1:J1')->applyFromArray($styleJudul);
	$doc->setActiveSheetIndex()->mergeCells('A1:J1')->setCellValue('A1', $judul);
	$doc->getActiveSheet()->getStyle('A2:J2')->applyFromArray($styleJudul);
	$doc->setActiveSheetIndex()->mergeCells('A2:J2')->setCellValue('A2', $subjudul);

	//set lebar kolom
	$doc->setActiveSheetIndex(0)->getColumnDimension('A')->setWidth(4);
	$doc->setActiveSheetIndex(0)->getColumnDimension('B')->setWidth(18);
	$doc->setActiveSheetIndex(0)->getColumnDimension('C')->setWidth(5);
	$doc->setActiveSheetIndex(0)->getColumnDimension('D')->setWidth(16);
	$doc->setActiveSheetIndex(0)->getColumnDimension('E')->setWidth(37);
	$doc->setActiveSheetIndex(0)->getColumnDimension('F')->setWidth(11);
	$doc->setActiveSheetIndex(0)->getColumnDimension('G')->setWidth(11);
	$doc->setActiveSheetIndex(0)->getColumnDimension('H')->setWidth(10);
	$doc->getActiveSheet(0)->getColumnDimension('I')->setAutoSize(true);
	$doc->getActiveSheet(0)->getColumnDimension('J')->setAutoSize(true);
	...
	$doc->getActiveSheet()->getStyle("A4:J4")->getFont()->setBold(true);
	$doc->getActiveSheet()->getStyle("A4:J4")->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
	$doc->getActiveSheet()->getStyle("A4:J4")->getFill()->getStartColor()->setRGB('215967');
	$doc->getActiveSheet()->getStyle("A4:J4")->applyFromArray($styleArray);
	$doc->setActiveSheetIndex(0)
		->setCellValue('A4', 'No')
		->setCellValue('B4', 'No. Sertifikat')
		->setCellValue('C4', 'Sesi')
		->setCellValue('D4', 'ID Student')
		->setCellValue('E4', 'Student Name')
		->setCellValue('F4', 'Microsoft Word 2016	')
		->setCellValue('G4', 'Microsoft Excel 2016')
		->setCellValue('H4', 'Microsoft Power Point 2016')
		->setCellValue('I4', 'Average')
	...
	//efek bold
	$doc->getActiveSheet()->getStyle("A" . $baris . ":J" . $baris)->getFont()->setBold(true);
	$doc->getActiveSheet()->getStyle("A" . $baris . ":J" . $baris)->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
	$doc->getActiveSheet()->getStyle("A" . $baris . ":J" . $baris)->getFill()->getStartColor()->setRGB('215967');
	$doc->getActiveSheet()->getStyle("A" . $baris . ":J" . $baris)->applyFromArray($styleArray);
	$doc->getActiveSheet()->getStyle("A" . $baris . ":J" . $baris)->getFont()->setBold(true);
	$doc->setActiveSheetIndex(0)
		->setCellValue('A' . $baris, 'No')
		->setCellValue('B' . $baris, 'No. Sertifikat')
		->setCellValue('C' . $baris, 'Sesi')
		->setCellValue('D' . $baris, 'ID Student')
		->setCellValue('E' . $baris, 'Student Name')
		->setCellValue('F' . $baris, 'Microsoft Word 2016')
		->setCellValue('G' . $baris, 'Microsoft Excel 2016')
		->setCellValue('H' . $baris, 'Microsoft Power Point 2016')
		->setCellValue('I' . $baris, 'Average')
		->setCellValue('J' . $baris, 'Status');
	$baris++;
	...
	$doc->getActiveSheet()->getStyle("A4:J" . $baris)->applyFromArray(
		array(
			'borders' =>
			array(
				'allborders' =>
