			...
			<div class="modal-header">
			    ...
			    <div class="modal-body">
			      ...
			      <div class="form-group">
							...
							<input class="form-control" type="text" name="subject_group" id="e_subject_group" value="<?=$result[4]?>" />
						</div>
			      <div class="form-group">
		...
		$(document).ready(function(){
		 var ac_config = {
			 ...
			 select: function(event, ui){
				 $("#e_subject_group").val(ui.item.subject_group);
				 $("#id").val(ui.item.id_subject);
			 },
			 minLength:1
		 };
		 $("#e_subject_group").autocomplete(ac_config);
		});
