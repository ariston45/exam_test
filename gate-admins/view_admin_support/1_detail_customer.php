...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-info">
			...
			$row = mysqli_fetch_array($result);
				echo "	<div class='col-md-6'>
						<a href=\"?pg=customer\" class=\"btn btn-xs btn-danger\" ><i class=\"fa fa-arrow-left\" ></i> Back</a>
		...
		<h3>User</h3>
		<!-- <button class="btn btn-xs btn-primary" data-toggle="modal" data-target="#add_user"><i class="fa fa-plus"></i> Add User</button><br><br> -->
