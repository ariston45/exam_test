...
<div class="row">
  ...
  <div class="col-md-12">
    <div class="panel panel-primary">
      <div class="panel-heading">Exam Create (Exams at home)</div>
            ...
            $result=editExamVoucher($id_g);
              while ($row = mysqli_fetch_array($result)) {
                ...
                echo "
                        ...
                        if($row[3]<=0){
                          if ($row[5]=='Postpaid') {
                          echo "<a href=\"?pg=st_home_create_exam&CC=".$row[0]."\" class=\"btn btn-block btn-sm btn-danger\">Use</a>";
                          } else {
...
<!--======================-->
  ...
  <script>
    ...
    function notif($idV){
      ...
      if (r == true) {
        window.location="?pg=st_home_create_exam&CC="+$idV;
      } else {
