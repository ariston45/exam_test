	...
	<div class="col-md-12">
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add_user" type="button"><i class="fa fa-plus"></i> Add User</button><br><br>
	    ...
	    <div class="modal-body">
				...
				<form action="" method="post" autocomplete="off">
					<div class="form-group">
						<label>Name</label>
						<input name="name" type="text" class="form-control" value="" placeholder="Fullname" id="name" required>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label>Address</label>
						<input name="address" type="text" class="form-control" value="" placeholder="Jl. Ir.Soekarno no.1">
					</div>
					<div class="form-group">
						<label>Phone</label>
