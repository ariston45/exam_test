...
if (isset($_POST['cmd'])) {
  switch ($_POST['cmd']) {
    ...
    case 'Upload';
      ...
      if ($inst == "import") {
        ...
        if ($ext == "xls") {
          ...
          unlink('../' . $GLOBALS['tmp-dir'] . $filename);
          unset($filename);
        } else {
    ...
    case 'Register':
      ...
      if ($n == 'sudah_dipakai') {
        echo '<script>alert("This ID is already used\nPlease use another ID ex: ' . $id . 'A or ' . $id . 'B");</script>';
        echo "<script>window.location.href = window.location.href;</script>";
      } else if ($n == false) {
  ...
  <div class="col-md-12">
    <div class="panel panel-info">
      ...
      <div class="panel-body">
        ...
        <div class="row">
          <div class="col-sm-6">
            <h5>Upload students with excel (.xls) format. For example file click <a
                href="../assets/sample_file/example.xls" download>here.</a> </h5>
