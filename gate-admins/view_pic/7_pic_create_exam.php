...
// Khusus UPY Minta waktu ujian 90 Menit        
      ...
      if ($insert_group) {
          CovidcreateSchedule($date, $time, $duration, $proctor, $insert_group[b], $class);
      }
            echo '
			<script>window.location.href ="dashboard.php?pg=st_home_schedule"</script>
			';
            // header('location:?pg=pic_exam_schedule');
            // die();
    break;
...
<div class="row">
	...
	<div class="col-lg-12">
		<div class="panel panel-primary">
			<div class="panel-heading">Create Schedule Exam (Exams at home)</div>
							...
							<form action="" method="post" enctype="multipart/form-data" autocomplete="off">
								<div class="panel-body">
									...
									<div class="row">
										...
										<div class="col-md-5" style="background-color: #ffecec;border: 1px solid #903a3a;    border-radius: 10px;">
											<h5><b>	Note : </b></h5>
											<h5>Students can start the exam from <b>07:00 </b>to <b>19:00 WIB</b></h5>
										</div>
										<!-- <div class="col-md-6">
										<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="range" class="form-control-range" name="plans_quota" id="ageInputId" value="0" min="0" max="<?=$max_stue; ?>"
											oninput="ageOutputId.value = ageInputId.value" style="max-width: 465px;">
										<input type="number" id="ageOutputId" class="form-control input-sm" name="plans_quota" value="0" style="max-width: 465px;" max="<?=$max_stue; ?>">
									</div>
									<div class="form-group">
									...
									<br>
									<p class="text-right">
										<a href="?pg=st_home_create" class="btn btn-warning btn-sm">Cancel</a>
