...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading"><a href="?pg=st_home_exam_result" class="btn btn-xs btn-danger"><i class="fa fa-arrow-left"></i> Back</a> &nbsp Exam Result (Exams at home)</div>
		        ...
		        <table class="table table-xs" id="tbStudents">
		          <thead>
			        <tr>
				  	...
				  	<?php
				  	$no=1;
					$q = CovidlistExamParticipants($dat[0]);
