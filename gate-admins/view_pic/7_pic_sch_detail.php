...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			<div class="panel-heading"><a href="?pg=st_home_schedule" class="btn btn-xs btn-danger"><i class="fa fa-arrow-left"></i> Back</a> &nbspSchedule (Exams at home)</div>
...
<script>
	$(document).ready(function(){
      ...
      $.ajax({
        type : 'GET',
        url  : 'view_pic/7_pic_dataparticipant.php', //Here you will fetch records 
        data : {id:idg},   //Pass $id
        success : function(data){
          $('#output').html(data);
        }
