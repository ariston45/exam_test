...
if (isset($_POST['user_id'])) {
  ...
  if ($t == 1) {
    ...
    $n = cekLogStu($user_id, $password); //cek alokasi peserta ujian
...
<body style="background-image:url('assets/img/background1.png'); ">

  <div class="row" style="width: 100%; margin-left: 0px">
    <div class="head">
      <img src="assets/img/logo_trust.png" style="max-height: 50px;padding:5px;margin-top: 10px;margin-left: 25px">
    </div>
    <div class="col-sm-12" style="margin-top: 35px; margin-bottom: 95px; padding: 15px;">
      ...
      <div class="column-right">
        <h2 align=center style="color: #001992;text-shadow: 0px 0px 3px white;margin-bottom: 5px;"><b> Student Login</b>
        </h2>
  ...
  <div class="foot" style="background-color: #000; height: 75px; position: fixed; width: 100%;bottom:0">
    <div class="row">
      <div class="col-sm-2"><img src="assets/img/logo_trust.png"
          style="max-height: 50px;padding:5px;margin-top: 10px;margin-left: 25px">
      </div>
      ...
      <div class="col-sm-4" style="text-align: right;"><img src="assets/img/ms_logo.png"
          style="padding: 5px;padding-right: 25px;max-height: 78px;"></div>
    </div>
  </div>
