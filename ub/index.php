...
if (isset($_POST['user_id'])) {
    ...
    if ($t == 1) {
        ...
        window.alert('Sorry, you can\'t sign in, because the allocation of exam participants is full.');
              window.location.href='../cv_logout.php';
              </script>";
        }
    } elseif ($t == 2) {
        $loginSukses = 0;
...
<div class="head">
  <img src="../assets/img/logo/logo-Universitas-Brawijaya.png" style="max-height: 70px;padding:5px;">
</div>
<div class="col-sm-12" style="margin-top: 35px; margin-bottom: 95px; padding: 15px;" >
  <div class="column-left" >
    ...
    <img class="t-logo" src="../assets/img/logo/logo-Universitas-Brawijaya.png" style="background: #f1f1f1d6;border-radius: 10px;">
  </div>
  <div class="column-right">
    <h2 align=center style="color: #2c4068;text-shadow: 0px 0px 3px white;margin-bottom: 5px;"><b> Student Login</b></h2>
